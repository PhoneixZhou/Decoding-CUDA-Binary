...
void cudaSafeCallWrapper(cudaError_t errmsg, char * callname)
{
...
int main(int argc, char *argv []){
	...
	FILE * fverify = fopen("output.txt","w");
	fwrite(common.tEpiRowLoc, common.epi_mem, common.no_frames, fverify);
	fclose(fverify);
